	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				attendanceSessionBean.setAttendance_session_department("MS");
				...
				studentBean.setStudent_mobilenumber("9744622185");
				studentBean.setStudent_address("pune");
				studentBean.setStudent_department("MS");
				studentBean.setStudent_class("Third");
