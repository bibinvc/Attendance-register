...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "MS"};
	...
	private String[] subjectFinal = new String[] {"MOBILE","JEE","PYTHON","ORACLE","LINUX","NETWORK","CEH","VIRTUALISATION","PROJECT","FLE"};
